...
Tests use [BATS](https://bats-core.readthedocs.io). Each shell script has a corresponding `.bats` file that mocks external tools and tests success, failure, and edge cases in isolation.
